...
* [`Docs/sistema/SISTEMA-PAINEL.md`](sistema/SISTEMA-PAINEL.md) — Interface web em Laravel 13 + Inertia + React 19, Channel Template Studio (9:16), modal de preview de clipes e controles.
